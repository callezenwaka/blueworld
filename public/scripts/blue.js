...
const footer_main_company_toggle = document.querySelector('.footer_main_company_toggle')
const footer_main_support_toggle = document.querySelector('.footer_main_support_toggle')
const footer_main_connect_toggle = document.querySelector('.footer_main_connect_toggle')
